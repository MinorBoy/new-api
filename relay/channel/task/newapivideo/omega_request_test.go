...
func TestOmegaAIRequestValidation(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "720p resolution", body: `{"model":"m","content":[{"type":"text","text":"text"}],"resolution":"720p"}`, upstreamModel: "klsdpro2-720p"},
		{name: "unsupported resolution", body: `{"model":"m","content":[{"type":"text","text":"text"}],"resolution":"1080p"}`, upstreamModel: "klsdpro2-720p", code: "InvalidParameter.resolution", wantErr: true},
