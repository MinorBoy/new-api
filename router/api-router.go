...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		registerRoutingPolicyRoutes(apiRouter)
		...
		tokenRoute.Use(middleware.UserAuth())
		{
			...
			tokenRoute.GET("/usage", controller.GetTokensUsage)
		...
		logRoute.GET("/models", middleware.AdminAuth(), controller.GetLogModels)
		logRoute.GET("/self/models", middleware.UserAuth(), controller.GetLogSelfModels)
		...
		{
			taskRoute.GET("/self/filter-options", middleware.UserAuth(), controller.GetUserTaskFilterOptions)
