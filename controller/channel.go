...
func isPreAcceptanceVideoChannel(channelType int) bool {
	switch channelType {
	case constant.ChannelTypeOmegaAI, constant.ChannelTypeFourSToken, constant.ChannelTypeEightYes, constant.ChannelTypeZ5API, constant.ChannelTypeZZone, constant.ChannelTypeMikoto, constant.ChannelTypeFFLink, constant.ChannelTypeWxArt:
		return true
	default:
		return false
	}
