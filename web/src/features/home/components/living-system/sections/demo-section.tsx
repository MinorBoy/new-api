  ...
  return (
    ...
    >
      <div className='mx-auto mb-16 max-w-[680px] text-center'>
        <span className='border-cyan/30 bg-cyan/10 text-cyan inline-flex items-center gap-2 rounded-full border px-2.5 py-1 font-mono text-xs tracking-[0.2em] uppercase'>
          // {t('live demo')}
        </span>
      ...
      <div className='relative py-7.5'>
        <div
          className='border-border bg-muted/30 relative overflow-hidden rounded-3xl border p-6 md:p-12'
          style={{
            background:
        ...
        <p className='text-muted-foreground/70 mt-5 text-center font-mono text-xs tracking-[0.1em]'>
