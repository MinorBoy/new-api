...
func TestValidateBillingRequestAcceptsConfiguredModelsWithinProtocolResolutions(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "jmg 2.5 480p", model: "jmg-video-seedance-2.5", resolution: "480p"},
		{name: "jmg 2.5 720p", model: "jmg-video-seedance-2.5", resolution: "720p"},
		{name: "jmg 2.5 1080p rejected", model: "jmg-video-seedance-2.5", resolution: "1080p", wantCode: "invalid_resolution"},
		{name: "jmg 2.5 4k rejected", model: "jmg-video-seedance-2.5", resolution: "4k", wantCode: "invalid_resolution"},
