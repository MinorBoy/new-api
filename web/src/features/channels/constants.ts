...
export const TYPE_TO_KEY_PROMPT: Record<number, string> = {
  ...
  211: 'Enter the raw API key issued by Z5API',
  212: 'Enter the raw API key issued by FYLink',
}
...
export const CHANNEL_TYPE_WARNINGS: Record<number, string> = {
  ...
  211: 'Z5API is task-only. Enable it only after real upstream contract acceptance.',
  212: 'FYLink is task-only. Enable it only after real upstream contract acceptance.',
}
