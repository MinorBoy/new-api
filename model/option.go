...
func InitOptionMap() {
	...
	common.OptionMap["GroupRoutingRequirements"] = ratio_setting.GroupRoutingRequirements2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "GroupRoutingRequirements":
		err = ratio_setting.UpdateGroupRoutingRequirementsByJSONString(value)
