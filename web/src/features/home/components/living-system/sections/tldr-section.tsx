...
const ITEMS = [
  {
    ...
    subKey: 'OpenAI-compatible. Swap one string, every model reachable.',
  },
  {
    num: '02',
  ...
  },
  {
    ...
    subKey:
      'Multi-region deployment with automatic failover keeps every request online.',
  },
] as const
  ...
  return (
    ...
    >
      <div className='border-border bg-muted/30 grid grid-cols-[auto_1fr] gap-8 rounded-3xl border p-8 md:p-11'>
        <div
          className='text-muted-foreground/70 border-violet hidden border-l-2 py-2 font-mono text-xs tracking-[0.2em] [writing-mode:vertical-rl] md:block'
        ...
        <div className='grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4'>
          {ITEMS.map((item) => (
            ...
            >
              <span className='text-violet font-mono text-sm font-semibold'>
                {item.num}
              </span>
              <div>
